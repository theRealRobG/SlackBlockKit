...
///   - `Section`
///   - `Input`
public struct MultiSelectMenuPublicChannelsList: BlockElement, InputBlockElement, SectionBlockElement, Equatable {
    public static let type = BlockElementType.multiChannelsSelect
